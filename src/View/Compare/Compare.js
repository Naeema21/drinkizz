            ...
            <div className='container  py-5 mb-2'>
                <div className='row'>
                    <div className='table-responsive'>
                        <table className='table table-bordered table-layout-fixed fs-sm table-striped' style={{"min-width":"45rem"}}>
                        <thead>
                        <tr>
                            <td className="align-middle">
                            <select className="form-select-compare" id="compare-criteria" data-filter-trigger="">
                                <option value="all">Comparison criteria</option>
                                <option value="summary">Summary</option>
                                {/* onClick={() => {summary ? setShowSummary(false) : setShowSummary(true)}} */}
                        ...
                        <tbody id="table-data-summary" data-filter-target="">
                            ...
                            <tbody id="summary" className='showsummary' data-filter-target="">
                                    {/* style={{display:summary ? "block":'none'}} */}
                                <tr class="heading-table-compare">
                                        ...
                                        <tbody id="performance" data-filter-target="">
                                            ...
                                            <tbody id="battery" data-filter-target="">
                                                ...
                                                <tr>
                                                    <th></th>
                                                    <td>
                                                    <button class="btn btn-danger d-block w-100 b-Addtocart" type="button">Add to Cart</button>
                                                    </td>
                                                    <td>
                                                    <button class="btn btn-danger d-block w-100 b-Addtocart" type="button">Add to Cart</button>
                                                    </td>
